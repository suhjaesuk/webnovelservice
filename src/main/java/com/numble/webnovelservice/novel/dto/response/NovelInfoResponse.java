...
public class NovelInfoResponse {
    ...
    @Builder
    public NovelInfoResponse(Long novelId, String title, String author, String genre, String coverImage, String serializedStatus, Integer likeCount, Integer totalViewCount, String updatedAt) {
    ...
    public static NovelInfoResponse toResponse(Novel novel){
