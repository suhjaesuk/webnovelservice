...
public enum ErrorCode {
    ...
    NOT_READ_OWNED_EPISODE(HttpStatus.BAD_REQUEST, "OWNED_EPISODE_004", "아직 읽음 처리 안된 에피소드입니다."),
    PAGE_NUMBER_IS_NULL(HttpStatus.BAD_REQUEST, "OWNED_EPISODE_005", "페이지 값이 없습니다."),
